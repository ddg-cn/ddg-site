...
*Business Ethics, Anti-Bribery & Supplier Financial Resilience*

供应链尽责管理系列　2025年版　适用范围：所有规模企业及其供应商
...
本指南是《供应链尽责管理系列》的组成部分，覆盖：

- 反贿赂与反腐败的法律框架（FCPA、英国《反贿赂法》、中国相关法律）
- 礼品、招待与第三方支付管控
- 利益冲突识别与管理
- 制裁合规与出口管制基础知识
- 供应商财务健康评估方法论（财务比率、Altman Z-score、现金流分析）
- 供应商财务韧性尽职调查流程
- 审核方法论与检查清单
...
**审核准备：** 直接跳至第八章（审核方法论）和第九章（检查清单）。

**快速了解财务风险：** 直接进入第五章（财务健康评估）和第六章（DD流程）。
:::

---

# 第一章　商业道德与财务韧性在DD体系中的定位

> *场景：* 你的采购团队与一家供应商合作了三年，关系顺畅，价格有竞争力。某天，一封匿名举报邮件到达合规部门：这家供应商的销售总监，每季度通过一个第三方咨询公司向你们的采购总监的配偶转账。调查发现，你们支付的采购价格比市场价高出约22%。
...
- DD强度应与供应商的**战略重要性×风险特征**匹配，而非一刀切
- 本套指南六个专项领域合计覆盖欧盟CSDDD要求评估的全部实质性风险类别
:::

## 1.1　为什么商业道德是DD支柱而非内控事项
...
```mermaid
flowchart LR
    A[供应链商业道德<br/>与财务韧性风险] --> B[反贿赂<br/>反腐败]
    A --> C[利益冲突<br/>财务舞弊]
    A --> D[财务韧性<br/>信用风险]
...
商业道德和财务韧性的DD强度应与供应商的战略重要性和风险特征相匹配：

| 维度 | 高风险标准（需深度DD） | 低风险标准（标准DD） |
| --- | --- | --- |
...
| 财务透明度 | 无经审计财务报告；拒绝提供财务信息；近期股东/管理层变动频繁 | 年审财务报告；稳定管理团队 |

::: warning 常见误区
**误区1：** "我们规模不大，不会被FCPA盯上。" — FCPA的执法对象包括任何使用美元结算或与美国上市公司有业务往来的企业，与企业规模无关。

**误区2：** "供应商的腐败行为是他们自己的问题。" — 一旦你的采购行为（包括支付溢价）成为腐败链条的一部分，采购方可能承担连带责任。

**误区3：** "财务评估是财务部的事，跟采购合规无关。" — 财务困难的供应商更容易出现腐败行为（用回扣换合同）和质量造假，三大风险域高度相关。

**误区4：** "我们每年审核一次就够了。" — 财务状况可在几个月内急剧恶化；制裁名单每天更新。年度审核对财务风险和制裁风险来说频率远远不够。
:::
...
ISO 37001:2016（反贿赂管理体系）提供了一套可认证的反贿赂管理框架，被越来越多的跨国企业作为供应商准入标准之一。理解ISO 37001有助于评估供应商的反腐败合规成熟度。

| 要素 | 核心内容 | 对供应商的意义 |
| --- | --- | --- |
| 领导力与承诺 | 最高管理层须明确示范反腐败立场；任命合规官；将反腐败纳入企业文化 | 最高管理层亲自签署反腐败政策；供应商管理层可直接回答合规问题 |
| 风险评估 | 识别并评估组织面临的贿赂风险（地理、行业、业务模式、客户类型） | 供应商须能展示已完成腐败风险图谱，识别高风险业务场景 |
| 尽职调查 | 对商业伙伴（含供应商、代理商、合营方）进行与其风险水平相称的背景调查 | 供应商须证明其对自身供应商/代理商进行了反腐败DD |
...
| 红旗信号 | 典型场景 | 应对措施 |
| --- | --- | --- |
| 异常高佣金 | 代理商要求20-30%以上的销售佣金，显著超出行业惯例（通常5-15%） | 要求代理商提供服务内容说明；对比行业佣金标准；必要时聘请独立第三方评估 |
...
::: warning 常见误区
**误区1：** "我们合同里有反腐败条款，法律责任就转移给供应商了。" — 合同条款是必要条件，但不充分。FCPA/UKBA要求你同时证明已**实际执行**了合理的DD程序，而非仅签了纸质合同。
...
**罗尔斯·罗伊斯案（2017年）**：劳斯莱斯通过"中介顾问"向印度尼西亚、泰国、巴西、印度等国政府航空公司官员行贿，换取发动机销售合同，最终向英、美、巴三国监管机构支付约6.71亿英镑（约合8亿美元）。调查显示该模式在公司内部持续运作超过20年，中间商网络极为隐蔽。

**共同启示：** 每一个案件的核心链条都是"销售压力 → 代理商/'顾问' → 政府官员 → 合同"。合规失守的代价不仅是巨额罚款，还包括高管个人承担刑事责任——皮耶鲁齐在美国联邦监狱服刑超过两年。
:::
...
> *场景：* 中秋节前，你的供应商销售代表为采购团队每人送来一盒价值680元的月饼礼盒，外加一张"感谢合作"卡片。你的采购助理已经收下，放在自己桌上。这需要处理吗？

::: tip 本章要点
- 礼品与招待（G&H）是**最常见的腐败入口**，但各国法律的容忍阈值差异显著
- 对**政府官员**的任何有价值给予，在英国UKBA框架下趋向零容忍；美国FCPA对"合理的推广性支出"设有安全港但须严格记录
...
- **美国：** FCPA对"合理、善意的推广性支出"有明确安全港规定（须在账簿中准确记录）；向政府官员的任何有价值给予均需谨慎评估
...
**供应商关联关系核查：**
- **核查工具：** Refinitiv World-Check；Dun & Bradstreet；国内可使用天眼查/企查查核查股权穿透关系
...
> *场景：* 你正在审批一笔向某东南亚客户的货款付款，付款目的地账户在一家你不太熟悉的银行。你的财务助理说"这家客户以前一直付款正常"。在你批准前，你需要做什么检查？
...
| 筛查对象 | 筛查频率 | 筛查工具 | 特殊注意 |
| --- | --- | --- | --- |
| 新供应商（准入时） | 一次性全面筛查（所有主要制裁名单） | OFAC SDN名单（免费）；Refinitiv World-Check（付费）；企查查/天眼查（国内） | 须筛查供应商的母公司、实际控制人（UBO）和主要高管，不仅限于注册实体本身 |
...
**误区2：** "我们的供应商不在名单上，就安全了。" — 50%所有权规则意味着你必须核查供应商的实际控制人（UBO）。一个看起来清白的供应商，其实际控制人可能是SDN名单主体。
...
品牌商立即将该供应商升级至Level 2 DD，发现其最大客户（占营收40%）正在调整采购策略，账期从45天延长至90天，导致供应商现金流受压。品牌商随即启动了**双轨并行**策略：一方面与该供应商共同寻找改善方案（提供提前付款激励，换取更优价格），另一方面开始认证第二家备用供应商。
...
> *场景：* 你的公司有180家供应商。你无法对每一家都做深度财务审查。如何设计一套可持续的、有轻重缓急的财务DD体系？

::: tip 本章要点
- 财务DD应按**四个层级**设计：从基础年度问卷（Level 1）到危机响应（Level 4），层层递进
...
财务DD的深度应与供应商的战略重要性和风险信号相匹配：

| DD层级 | 触发条件 | DD内容 | 频率 |
| --- | --- | --- | --- |
| 标准DD（Level 1） | 所有现有/新增供应商 | 年度财务问卷（自填）；核心财务比率计算；Z-Score初步评估；制裁名单筛查 | 每年一次 |
| 增强DD（Level 2） | 战略关键供应商；Z-Score<2.5；单一供应风险供应商；年采购额>500万元 | 经审计财务报告审阅（近3年）；现金流深度分析；管理层访谈；银行信用状况核查；主要客户集中度分析 | 每年一次，必要时每半年 |
| 深度DD（Level 3） | Z-Score<1.81的供应商；存在财务舞弊信号；重大合同签署前；并购相关供应商 | 第三方财务审计/审阅；UBO核查；诉讼/仲裁记录核查；银行授信核实；抵押担保情况核查；管理层及大股东背景调查 | 事件触发；关键合同前 |
...
| 预警信号 | 严重程度 | 触发升级动作 |
| --- | --- | --- |
| 年度Z-Score降入1.81-2.99灰色区 | 黄色预警 | 通知采购管理层；启动Level 2 DD；密切关注季度财务动态 |
| 年度Z-Score降入<1.81危险区 | 橙色预警 | 启动Level 3 DD；评估替代供应商；重新评估预付款比例；向供应链韧性委员会汇报 |
| 供应商主动通知现金流困难 | 红色预警 | 48小时内召开紧急评估会议；法务评估合同终止条款和资产保全；启动Level 4危机DD |
| 外部信用评级下调≥2个级别 | 橙色预警 | 立即启动Level 2 DD；与供应商管理层开展财务状况讨论 |
| 发现财务数据造假信号（利润与现金流严重背离） | 红色预警 | 暂停付款；启动法务调查；外部审计评估；考虑全面暂停合作 |
| 主要银行贷款被提前收回（媒体/公告披露） | 红色预警 | 紧急启动Level 4 DD；评估库存安全水位；通知供应链韧性团队启动应急方案 |
...
**误区3：** "我们对所有供应商进行同等深度的财务评估。" — 这既浪费资源，又导致对高风险供应商的监控深度不够。分层DD框架确保资源集中在真正需要深度关注的供应商上。
:::
...
| 4. 第三方管控（15分） | 代理商/中间商DD程序是否存在 | 8 | 无程序=0；有程序但不规范=4；规范程序+历史记录=8 |
...
| 机构/资源 | 类型 | 用途 | 访问方式 |
| --- | --- | --- | --- |
| OFAC SDN名单 | 美国财政部官方制裁名单 | 全球最重要的制裁名单；日常更新；免费查询 | ofac.treas.gov 支持批量查询API |
...
| 天眼查 / 企查查 | 国内商业数据库（免费+付费） | 中国企业工商信息、股权穿透、法院判决记录、失信被执行人 | tianyancha.com / qcc.com |
| Transparency International CPI | 年度腐败感知指数 | 按国家排名的腐败感知评分；用于地理风险分级（每年1月更新） | transparency.org |
| FCPA Resource Guide（DOJ/SEC联合） | 官方执法指南 | 美国司法部和SEC联合发布的FCPA执法指引；含案例分析和safe harbor说明 | justice.gov（免费下载） |
...
| [审核前文件请求清单 五（道德与财务）](/zh/templates/audit-checklist) | 第八章 审核方法论 |
...
| [财务预警升级申请表](/zh/templates/forms#表单七财务预警升级申请表) | 第六章 财务DD |
