...
本术语表配套《供应链尽责管理系列》全套六册指南使用：《供应链尽责管理实操指南》《劳工与社会责任审核指南》《环境合规审核指南》《供应链安全、网络与数据合规审核指南》《知识产权保护与防伪打假指南》《商业道德、反贿赂与财务韧性指南》

*术语按主题分类，每条目含中文名称、英文原名及简明定义。
如需比较相关认证标准，请参阅 standardsmap.org。*

# 一、尽职调查基础

## 尽职调查（Due Diligence (DD)）

企业为识别、预防和减轻其运营及供应链中的潜在负面影响（人权、环境、腐败等）而开展的持续性风险管理过程。本套指南所指尽职调查以OECD《经合组织负责任商业行为尽责管理指南》为基础框架。

## 经合组织负责任商业行为尽责管理指南（2018年版）

经济合作与发展组织（OECD）发布的《经合组织负责任商业行为尽责管理指南》（2018年版），以及针对农业、服装、金融等行业的衍生指南。为企业建立五步尽职调查流程提供国际认可框架。
...
采矿选矿后剩余的细颗粒废料（尾矿）及其储存设施（尾矿库）。尾矿库失稳溃坝是矿山最严重的安全与环境事故类型之一（参见巴西Brumadinho坝溃事故，2019；印尼莫罗瓦利工业园区(IMIP)尾矿坝崩塌，2025年）。
...
产品全生命周期（从原材料提取到废弃处置）内GHG排放总量，以kg CO₂e/功能单位表示。核算标准：ISO 14067；欧盟官方方法论：PEF（产品环境足迹）。也叫做CFP, Carbon Footprint of a Product.
...
## SLCP（Social \& Labor Convergence Program，社会劳工整合项目）

SLCP（Social \& Labor Convergence Program，社会劳工整合项目），覆盖招募与录用、薪酬、工时、员工对待、健康与安全、管理体系、社区福祉等议题。

## Higg工厂环境模块（Higg Facility Environmental Module (FEM)）

由Cascale（原可持续服装联盟（SAC））开发的工厂环境自评工具，涵盖能源/GHG、水、废水、化学品、废物、空气质量、环境管理7个模块。H\&M、Nike等品牌要求战略供应商完成年度FEM并经第三方核实。官网：worldly.io。

## Higg工厂社会劳工模块（Higg Facility Social Labor Module (FSLM)）

由SLCP开发的社会劳工评估工具，Worldly采用为其工厂社会劳工自评工具（FSLM），与FEM并行，覆盖招募与录用、薪酬、工时、员工对待、健康与安全、管理体系、社区福祉等议题。
...
## VAP经验证审核流程（Validated Audit Process (VAP)）

RBA开发的供应商审核标准流程，由RBA认证审核机构执行，审核报告上传至RBA平台供成员企业共享，减少同一供应商被重复审核。
...
## Textile Exchange（纺织交流组织）

Textile Exchange是非营利组织，管理GRS（全球回收标准）、OCS（有机含量标准）、RCS（再生声明标准）、RDS（负责任羽绒标准）等纺织原料认证。发布年度《首选纤维与材料市场报告》。官网：textileexchange.org。

## Cascale（原SAC: Sustainable Apparel Coalition（可持续服装联盟））

服装、鞋类和家用纺织行业多方联盟，开发了Higg Index工具套件（FEM/MSI等）。官网：cascale.org。
...
|Cascale|原可持续服装联盟（Sustainable Apparel Coalition, SAC）|
...
|FSLM|Higg工厂社会劳工模块（Facility Social Labor Module）|
...
|VAP|RBA经验证审核流程（Validated Audit Process）|
...
*— 术语表完 —
如需比较本表所列认证标准的覆盖范围与适用条件，请访问 standardsmap.org
本表将随相关法规和标准更新持续修订，请以各机构官网最新文件为权威依据。*
